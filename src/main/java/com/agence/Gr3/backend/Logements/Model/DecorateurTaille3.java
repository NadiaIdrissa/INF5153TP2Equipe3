...
public class DecorateurTaille3 implements Logement {

    private Logement logementDeBase;
    private double supplement = 500.00;
    private double taille = 3.5;

    public DecorateurTaille3(Logement logementDeBase) {
