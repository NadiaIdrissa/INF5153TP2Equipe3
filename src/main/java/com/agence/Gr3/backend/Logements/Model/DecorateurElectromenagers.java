...
public class DecorateurElectromenagers implements Logement {

    private Logement logementDeBase;
    private double supplement = 75.00;
    private boolean electromenagers = true;

    public DecorateurElectromenagers(Logement logementDeBase) {
