...
public class DecorateurMeuble implements Logement {

    private Logement logementDeBase;
    private double supplement = 100.00;
    private boolean meuble = true;

    public DecorateurMeuble(Logement logementDeBase) {
