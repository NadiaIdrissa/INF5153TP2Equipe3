...
public class DecorateurTaille2 implements Logement {

    private Logement logementDeBase;
    private double supplement = 250.00;
    private double taille = 2.5;

    public DecorateurTaille2(Logement logementDeBase) {
