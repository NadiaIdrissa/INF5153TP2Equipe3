...
public class DecorateurTaille5 implements Logement {

    private Logement logementDeBase;
    private double supplement = 1000.00;
    private double taille = 5.5;

    public DecorateurTaille5(Logement logementDeBase) {
