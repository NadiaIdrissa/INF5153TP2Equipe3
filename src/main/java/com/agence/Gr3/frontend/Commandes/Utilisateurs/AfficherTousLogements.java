...
@Component
public class AfficherTousLogements implements Commande<StringBuilder, String> {

    private FormulairesLogement formulairesLogement;

    @Autowired
    public AfficherTousLogements(FormulairesLogement formulairesLogement) {
    ...
    public String execute(List<Permission> permissions, Scanner scanner, StringBuilder JWT) {
        return formulairesLogement.afficherTousLogements(permissions, scanner, JWT);
