...
@Component
public class ModifierLogement implements Commande<StringBuilder, String> {

    private FormulairesLogement formulairesLogement;

    @Autowired
    public ModifierLogement(FormulairesLogement formulairesLogement) {
    ...
    public String execute(List<Permission> permissions, Scanner scanner, StringBuilder JWT) {
        return formulairesLogement.modifierLogement(permissions, scanner, JWT);
